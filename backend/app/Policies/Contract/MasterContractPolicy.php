...
class MasterContractPolicy
{
    /**
     * 通用权限：只有创建人或管理员可以编辑草稿/驳回状态的合同内容
     */
    public function edit(User $user, MasterContract $contract): bool
    {
     ...
     * 提交审核：仅创建人，且状态允许提交
     */
    public function submit(User $user, MasterContract $contract): bool
    {
     ...
     * 撤回：仅创建人，且状态为审批中
     */
    public function withdraw(User $user, MasterContract $contract): bool
    {
     ...
     */
    public function approve(User $user, MasterContract $contract): bool
    {
     ...
     */
    public function reject(User $user, MasterContract $contract): bool
    {
     ...
     */
    public function void(User $user, MasterContract $contract): bool
    {
     ...
     * 终止：创建人或管理员，且状态为已生效
     */
    public function terminate(User $user, MasterContract $contract): bool
    {
     ...
     */
    public function addClause(User $user, MasterContract $contract): bool
    {
     ...
     */
    public function view(User $user, MasterContract $contract): bool
    {
        return true;
    }
}
