        ...
        <div class="row q-col-gutter-md">
          ...
          <div class="col-12">
            ...
            <q-list dense bordered separator class="rounded-borders">
              ...
              <q-item>
                <q-item-section class="col-4 col-sm-3"><strong>linkId</strong></q-item-section>
                <q-item-section>{{ detail.link_id ?? '-' }}</q-item-section>
              </q-item>
            </q-list>
          </div>
          ...
          <!-- 转发日志 -->
          <div class="col-12" v-if="detail.forward_log">
            <div class="text-subtitle1 text-primary q-mb-sm">转发日志</div>
            <q-card flat bordered class="bg-grey-1">
              <q-card-section>
                <pre class="json-preview">{{ detail.forward_log }}</pre>
              </q-card-section>
            </q-card>
          </div>
